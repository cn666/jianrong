(function ($, window, document, undefined) {
    ...
    function showTooltip() {
        ...
        $jpWalkthrough.appendTo("body").show();
        $("#tooltipWrapper").css(textRotation);
        //$("#tooltipWrapper").append("<div class='guide'></div>");
        switch (step.popup.position) {
            case "top":
               $("#tooltipWrapper").append("<div class='guide-top'></div>");
                break;
            case "right":
               $("#tooltipWrapper").append("<div class='guide-right'></div>");
                break;
            case "bottom":
                $("#tooltipWrapper").append("<div class='guide-bottom'></div>");
                break;
            case "left":
                $("#tooltipWrapper").append("<div class='guide-left'></div>");
                break
        }
        $("#tooltipInner").append(getContent(step)).show();
