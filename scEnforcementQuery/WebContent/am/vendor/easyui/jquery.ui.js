...
(function($) {
	...
	function _b2(_b3, _b4) {
		...
		if (bb.after) {
			if(_b7==0){
				bb.after.html(_b6.afterPageText.replace(/{pages}/, 1));
			}else{
...
(function($) {
	...
	function _27d(_27e) {
		...
		var win = $(_27e).panel($.extend({}, _27f.options, {
			...
			doSize: true,
			closed: true,
			cls: "window " + (_27f.options.windowCls ? ' ' + _27f.options.windowCls : ''),
			headerCls: "window-header " + (_27f.options.headerCls ? ' ' + _27f.options.headerCls : ''),
...
/*		//add dynamic columns
		if (data != null && data.columns != null) {
			var opts = $.data(_716, "datagrid").options;
			var columns = $.data(_716, "datagrid").options.columns[0];
     ...
     /*   //add dynamic columns begin
		if(data!=null && data.cols!=null){  
		    var opts=$.data(_716, "datagrid").options;             
		    var cols = $.data(_716, "datagrid").options.columns[0];        
